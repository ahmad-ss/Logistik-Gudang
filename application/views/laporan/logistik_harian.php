...
<div class="col-md-12">
	<form id="form-laporan">
		<div class="col-md-3">
			<select class="form-control selectpicker" name="kd_item" data-live-search="true" required>
		...
		<div class="col-md-3">
			<input type="text" class="form-control datepicker" name="tglawl" placeholder="(Tanggal awal)" autocomplete="off" required>
		</div>
		<div class="col-md-3">
			<input type="text" class="form-control datepicker" name="tglakr" placeholder="(Tanggal akhir)" autocomplete="off" required>
		</div>
		<div class="col-md-3">
...
$(document).ready(function(){
	...
	form.submit(function(e){
		e.preventDefault();
		$.ajax({
			url:'../laporan/laporanLogistikHarian',
			type:'POST',
			data:form.serialize(),
			beforeSend:function(){
